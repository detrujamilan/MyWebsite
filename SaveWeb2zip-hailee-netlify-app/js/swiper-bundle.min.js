  ...
  const Z = [
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function p() {
        ...
        if (
          ("fraction" === s.type &&
            (p.find(Y(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            p.find(Y(s.totalClass)).text(s.formatFractionTotal(u))),
          "progressbar" === s.type)
        ) {
          let t;
        ...
        q({
          ...
          setTransition: (t) => {
            ...
            (s ? e.slides.find(s) : e.slides).transition(t),
              U({ swiper: e, duration: t, transformEl: s, allSlides: !0 });
          },
          overwriteParams: () => ({
            slidesPerView: 1,
            slidesPerGroup: 1,
        ...
        q({
          ...
          setTranslate: () => {
            ...
            for (let i = 0; i < t.length; i += 1) {
              ...
              if (
                ...
                0 === t.length &&
                  (t = K(a, r, e.isHorizontal() ? "left" : "top")),
                  0 === s.length &&
                    (s = K(a, r, e.isHorizontal() ? "right" : "bottom")),
          ...
          setTransition: (t) => {
            ...
            (s ? e.slides.find(s) : e.slides)
              ...
              .transition(t),
              U({ swiper: e, duration: t, transformEl: s });
          },
          perspective: () => !0,
          overwriteParams: () => ({
            slidesPerView: 1,
              ...
              if (
                ...
                let e = n
                  ...
                  s = n
                    ? t.find(".swiper-slide-shadow-right")
                    : t.find(".swiper-slide-shadow-bottom");
                0 === e.length && (e = K(r, t, n ? "left" : "top")),
                  0 === s.length && (s = K(r, t, n ? "right" : "bottom")),
