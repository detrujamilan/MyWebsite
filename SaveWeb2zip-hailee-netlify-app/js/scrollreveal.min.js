...
var ScrollReveal = (function () {
      ...
      s(r(e), function (e) {
        ...
        if (null !== i) {
          ...
          r.callbackTimer && window.clearTimeout(r.callbackTimer.clock),
            p(r.node, r.styles.inline.generated),
  ...
  function y(e) {
    ...
    if (o(e))
      return (
        s(t, function (t) {
          s(t, function (t, n) {
            o(t) ? ((e[n] && o(e[n])) || (e[n] = {}), y(e[n], t)) : (e[n] = t);
          });
        }),
        e
      );
  ...
  function T(e, t) {
    ...
    var n = this.store.sequences[e.sequence.id],
      i = e.sequence.index;
    if (n) {
      var r = new O(n, "visible", this.store),
        o = new O(n, "revealed", this.store);
      if (((n.models = { visible: r, revealed: o }), !o.body.length)) {
        var s = n.members[r.body[0]],
          a = this.store.elements[s];
        if (a)
          return (
            x.call(this, n, r.body[0], -1, t),
            x.call(this, n, r.body[0], 1, t),
            E.call(this, a, { reveal: !0, pristine: t })
          );
      }
      if (
        !n.blocked.head &&
      ...
      if (
        ...
        return (
          x.call(this, n, i, 1, t), E.call(this, e, { reveal: !0, pristine: t })
        );
    }
  }
  function k(e) {
  ...
  function R(t, n, i) {
    ...
    var c,
      g = [],
      E = n.interval || e.interval;
    try {
      E && (c = new k(E));
      var j = r(t);
      if (!j.length) throw new Error("Invalid reveal target.");
      s(
        j.reduce(function (e, t) {
          var i = {},
            a = t.getAttribute("data-sr-id");
          a
            ? (y(i, o.store.elements[a]), p(i.node, i.styles.inline.computed))
            : ((i.id = b()),
              (i.node = t),
              (i.seen = !1),
              (i.revealed = !1),
              (i.visible = !1));
          var w = y({}, i.config || o.defaults, n);
          if ((!w.mobile && v()) || (!w.desktop && !v()))
            return a && m.call(o, i), e;
          var E,
            j = r(w.container)[0];
          ...
          return (
            j.contains(t) &&
              (null ===
                ...
                })(j, g, o.store.containers)) &&
                ((E = b()), g.push({ id: E, node: j })),
              (i.config = w),
              (i.containerId = E),
              (i.styles = (function (e) {
                ...
                var s,
                  ...
                  O = isNaN(parseFloat(i.opacity))
                    ? parseFloat(t.opacity)
                    : parseFloat(i.opacity),
                  x = {
                    computed: k !== O ? "opacity: " + k + ";" : "",
                    generated: k !== O ? "opacity: " + O + ";" : "",
                  },
                  R = [];
                if (parseFloat(i.distance)) {
                  ...
                  ("top" !== i.origin && "left" !== i.origin) ||
                    (A = /^-/.test(A) ? A.substr(1) : "-" + A);
                  var P = A.match(/(^-?\d+\.?\d?)|(em$|px$|%$)/g),
                    L = P[0];
                  switch (P[1]) {
                    case "em":
                      A = parseInt(t.fontSize) * L;
                      break;
                    case "px":
                      A = L;
                      break;
                    case "%":
                      A =
                        "Y" === q
                          ? (e.node.getBoundingClientRect().height * L) / 100
                          : (e.node.getBoundingClientRect().width * L) / 100;
                      break;
                    default:
                  ...
                  "Y" === q
                    ? R.push(((c = A), ((p = d())[13] = c), p))
                    : R.push(((s = A), ((a = d())[12] = s), a));
                }
                i.rotate.x &&
                  R.push(
                    ((m = i.rotate.x),
                    (y = (Math.PI / 180) * m),
                    ((v = d())[5] = v[10] = Math.cos(y)),
                    (v[6] = v[9] = Math.sin(y)),
                    (v[9] *= -1),
                    v)
                  ),
                  ...
                  i.rotate.z &&
                    R.push(
                      ((E = i.rotate.z),
                      (j = (Math.PI / 180) * E),
                      ((T = d())[0] = T[5] = Math.cos(j)),
                      (T[1] = T[4] = Math.sin(j)),
                      (T[4] *= -1),
                      T)
                    ),
                  1 !== i.scale &&
                    (0 === i.scale ? R.push(f(2e-4)) : R.push(f(i.scale)));
                var M = {};
                if (R.length) {
                  (M.property = h("transform")),
                    (M.computed = {
                      raw: t[M.property],
                      matrix: (function (e) {
                        if ("string" == typeof e) {
                    ...
                    R.unshift(M.computed.matrix);
                  var I = R.reduce(u);
                  M.generated = {
                    initial: M.property + ": matrix3d(" + I.join(", ") + ");",
                    final:
                      M.property +
                      ": matrix3d(" +
                ...
                if (x.generated || M.generated.initial) {
                  (N.property = h("transition")),
                    (N.computed = t[N.property]),
                    (N.fragments = []);
                  var z = i.delay,
                    F = i.duration,
                    D = i.easing;
                  x.generated &&
                    N.fragments.push({
                      delayed:
                        "opacity " + F / 1e3 + "s " + D + " " + z / 1e3 + "s",
                      instant: "opacity " + F / 1e3 + "s " + D + " 0s",
                    }),
                    M.generated.initial &&
                      N.fragments.push({
                        delayed:
                          ...
                          z / 1e3 +
                          "s",
                        instant: M.property + " " + F / 1e3 + "s " + D + " 0s",
                      }),
                    N.computed &&
                      !N.computed.match(/all 0s|none 0s/) &&
                      N.fragments.unshift({
                        delayed: N.computed,
                        instant: N.computed,
                      });
                  var S = N.fragments.reduce(
                    function (e, t, n) {
                      return (
                  ...
                  N.generated = {
                    delayed: N.property + ": " + S.delayed + ";",
                    instant: N.property + ": " + S.instant + ";",
                  };
        ...
        function (e) {
          (o.store.elements[e.id] = e).node.setAttribute("data-sr-id", e.id);
        }
      );
    } catch (t) {
    ...
    s(g, function (e) {
      o.store.containers[e.id] = { id: e.id, node: e.node };
    }),
    ...
    void 0 === e && (e = { type: "init" }),
      ...
      L(function () {
        ...
        s(n.store.containers, function (e) {
          ...
          e.scroll &&
            (e.direction = {
              x: A(t.left - e.scroll.left),
              y: A(t.top - e.scroll.top),
            }),
            (e.scroll = t);
        }),
          s(t, function (e) {
            (i || void 0 === e.geometry) && (e.geometry = M.call(n, e)),
          ...
          s(t, function (e) {
            e.sequence ? T.call(n, e) : E.call(n, e);
          }),
          (n.pristine = !1);
      });
  }
  ...
  function $(i) {
    ...
    try {
      if (!r(o.container)[0]) throw new Error("Invalid container.");
    } catch (i) {
      return a.call(this, i.message), n();
    }
    return (!(C = o).mobile && v()) || (!C.desktop && !v())
      ? (a.call(
          this,
      ...
      : (t(),
        ...
        (z =
          ...
          function () {
            var e = this;
            s(this.store.elements, function (e) {
              p(e.node, e.styles.inline.generated),
