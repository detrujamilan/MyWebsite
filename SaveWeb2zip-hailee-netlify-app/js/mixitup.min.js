...
!(function (t) {
  ...
  !(function () {
        ...
        (Object.keys = (function () {
          ...
          return (
            ...
            function (i) {
              ...
              for (r in i) a.call(i, r) && o.push(r);
              if (t) for (s = 0; s < n; s++) a.call(i, e[s]) && o.push(e[s]);
              return o;
            }
          );
        })()),
      ...
      "function" != typeof Object.create &&
        (Object.create = (function (t) {
          ...
          return function (t, n) {
            ...
            return (
              (e.prototype = null),
              undefined !== n && Object.defineProperties(a, n),
              null === t && (a.__proto__ = null),
              a
            );
          };
        })()),
    ...
    ((e = function (a, i, o) {
      ...
      else if (a && "object" == typeof a && n.isElement(a, u)) d = [a];
      else {
      ...
      for (m = 0; (r = d[m]) && (!(m > 0) || s); m++)
        r.id ? (h = r.id) : ((h = "MixItUp" + n.randomHex()), (r.id = h)),
          e.instances[h] instanceof e.Mixer
            ? ((l = e.instances[h]),
              (!i || (i && i.debug && !1 !== i.debug.showWarnings)) &&
                console.warn(e.messages.warningFactoryPreexistingInstance()))
            : ((l = new e.Mixer()).attach(r, u, h, i), (e.instances[h] = l)),
          (c = new e.Facade(l)),
          i && i.debug && i.debug.enable ? f.push(l) : f.push(c);
      return s ? new e.Collection(f) : f[0];
    }).use = function (t) {
    ...
    (n = {
      ...
      handleExtendError: function (t, n) {
        ...
        if (
          ...
          throw (
            (c > 1 &&
              (r = e.messages.errorConfigInvalidPropertySuggestion({
                probableMatch: s,
              })),
      ...
      getCustomEvent: function (e, n, a) {
        ...
        return (
          ...
          "function" == typeof t.CustomEvent
            ...
            ? (i = a.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, n)
            : (((i = a.createEventObject()).type = e),
              (i.returnValue = !1),
              (i.cancelBubble = !1),
              (i.detail = n)),
          i
      ...
      createElement: function (e, n) {
        var a = null,
          i = null;
        for (
          a = (n = n || t.document).createDocumentFragment(),
            (i = n.createElement("div")).innerHTML = e.trim();
          i.firstChild;
    ...
    (e.Base.prototype = {
      ...
      callActions: function (t, e) {
        var a = this.constructor.actions[t],
          i = "";
        if (a && !n.isEmptyObject(a)) for (i in a) a[i].apply(this, e);
      },
      callFilters: function (t, e, a) {
        var i = this.constructor.filters[t],
          o = e,
          r = "";
        if (!i || n.isEmptyObject(i)) return o;
        for (r in ((a = a || []), i))
          (a = n.arrayFromList(a)).unshift(o), (o = i[r].apply(this, a));
        return o;
      },
    }),
    ...
    n.extend(e.Control.prototype, {
      ...
      handleClick: function (t) {
        ...
        if (
          ...
          switch (a.type) {
            case "filter":
              s.filter = a.filter || i.getAttribute("data-filter");
              break;
            case "sort":
              s.sort = a.sort || i.getAttribute("data-sort");
              break;
            case "multimix":
              (s.filter = a.filter || i.getAttribute("data-filter")),
                (s.sort = a.sort || i.getAttribute("data-sort"));
              break;
            case "toggle":
              (s.filter = a.filter || i.getAttribute("data-toggle")),
                (r =
                  "live" === a.status
                    ? n.hasClass(i, a.classNames.active)
                    : "active" === a.status);
          }
          for (u = 0; u < a.bound.length; u++)
            (l = new e.CommandMultimix()), n.extend(l, s), c.push(l);
          for (
            c = a.callFilters("commandsHandleClick", c, arguments),
    ...
    n.extend(e.Mixer.prototype, {
      ...
      attach: function (a, i, o, r) {
        ...
        for (
          s.callActions("beforeAttach", arguments),
            ...
            void 0 === t.console && (s.config.debug.showWarnings = !1),
      ...
      getInitialState: function () {
        ...
        if (
          ...
          (n.activeFilter = t.parseFilterArgs([t.config.load.filter]).command),
            ...
            (n = t.callFilters("stateGetInitialState", n, arguments)).activeSort
              .collection ||
      ...
      indexTargets: function () {
        ...
        if (t.dom.targets.length) {
          for (r = 0; (i = t.dom.targets[r]); r++)
            (a = new e.Target()).init(i, t, o ? o[r] : void 0),
              (a.isInDom = !0),
              t.targets.push(a);
          t.dom.parent =
        ...
        for (l = 0; (n = e.controlDefinitions[l]); l++)
          if (t.config.controls.live || n.live) {
            ...
            for (
              ...
              (s = t.getControl(i, n.type, "")) && t.controls.push(s);
      ...
      sortOperation: function (t) {
        ...
        if (
          ...
          for (i = [], s = 0; (r = t.newSort.collection[s]); s++) {
            ...
            (o = new e.Target()).init(r, a), (o.isInDom = !0), i.push(o);
          }
          t.newOrder = i;
        } else
      ...
      getAttributeValue: function (t, n) {
        var a = this,
          i = "";
        return (
          null === (i = t.dom.el.getAttribute("data-" + n)) &&
      ...
      getTweenData: function (t) {
        ...
        for (
          ...
          for (
            (i = t.showPosData[u]).posIn = new e.StyleData(),
            ...
            (s = n.effectsIn[r]) instanceof e.TransformData &&
              s.value &&
        ...
        for (u = 0; (a = t.toHide[u]); u++)
          for (
            (i = t.toHidePosData[u]).posIn = new e.StyleData(),
              i.posOut = new e.StyleData(),
              i.tweenData = new e.StyleData(),
            ...
            (s = n.effectsOut[r]) instanceof e.TransformData &&
              s.value &&
              ((i.posIn[r].value = 0),
      ...
      moveTargets: function (t) {
        ...
        for (
          ...
          (o = new e.IMoveData()),
            ...
            (l = a.willTransition(s, t.hasEffect, r.posIn, r.posOut)) && c++,
            i.show(),
            (o.posIn = r.posIn),
            (o.posOut = r.posOut),
            (o.statusChange = s),
      ...
      hasEffect: function () {
        ...
        for (o = 0; (n = e[o]); o++)
          if (
            0 !== ("undefined" !== (a = t.effectsIn[n]).value ? a.value : a)
          ) {
            i = !0;
            break;
          }
      ...
      parseDatasetArgs: function (t) {
        var a = new e.UserInstruction(),
          i = null,
          o = -1;
        for (
          a.animate = this.config.animation.enable,
            a.command = new e.CommandDataset(),
            o = 0;
          o < t.length;
          o++
        )
      ...
      parseChangeLayoutArgs: function (t) {
        ...
        for (
          a.animate = this.config.animation.enable,
            a.command = new e.CommandChangeLayout(),
            o = 0;
          o < t.length;
          o++
        )
      ...
      getDataOperation: function (t) {
        ...
        return (
          ...
          a.callFilters("operationMappedGetDataOperation", i, arguments)
        );
      },
      diffDatasets: function (t) {
        ...
        for (
          ...
          if (
            void 0 === (d = s[a.config.data.uidKey]) ||
            d.toString().length < 1
          )
            throw new TypeError(
          ...
          (h[d] = !0),
            (l = a.cache[d]) instanceof e.Target
              ? (a.config.data.dirtyCheck &&
                ...
                (c = l.dom.el))
              : ((l = new e.Target()).init(null, a, s), l.hide()),
            l.isInDom
      ...
      dataset: function () {
        ...
        return (
          ...
          t.isBusy
            ? (((i = new e.QueueItem()).args = arguments),
              (i.instruction = n),
              t.queueMix(i))
        ...
        return (
          ...
          a.isBusy
            ...
            : (l && a.insertTargets(l, c),
              ...
              (c.newFilter =
                o || n.extend(new e.CommandFilter(), c.startFilter)),
    ...
    n.extend(e.Target.prototype, {
      ...
      init: function (t, n, a) {
        ...
        if (
          ...
          if (
            void 0 === (o = a[n.config.data.uidKey]) ||
            o.toString().length < 1
          )
            throw new TypeError(
              e.messages.errorDatasetInvalidUidKey({
      ...
      render: function (t) {
        ...
        return (
          (s = i(t)) && "object" == typeof s && n.isElement(s)
            ? (o = s)
            : "string" == typeof s &&
